...
TEST_F(ImageInfoSetup, test_getUrlByIndex) {
    imageInfo.initializeUrls();
    EXPECT_EQ(imageInfo.getUrlByIndex(0).toStdString(),correctUrls.at(0));
    EXPECT_EQ(imageInfo.getUrlByIndex(1).toStdString(),correctUrls.at(1));
